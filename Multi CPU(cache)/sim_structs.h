...
struct CPU{
	...
	unsigned int currentJobTotalSize;
	
	//program pointers for RAM
  	unsigned int* current_job_start_RAM;
  	unsigned int* current_job_end_RAM;
  	
  	//program pointers for cache
  	unsigned int* current_job_start_cache;
  	unsigned int* current_job_end_cache;
